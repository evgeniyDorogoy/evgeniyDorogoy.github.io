...
registration authority (Bescheinigung der deutschen Anmeldebehörde) to verify my address, as well as my Ukrainian 
...
When I went through the process, I chose the [Zollamt Schöneberg](https://www.zoll.de/SharedDocs/Dienststellen/DE/1_DSSD_Importer/Hauptzollamt/HZA_Berlin/ZA/ZA_Schoeneberg_2151/ZA_Schoeneberg_2151.html){:target="_blank"}{:rel="noopener noreferrer"} in Berlin.
...
"Unbedenklichkeitsbescheinigung für die Zulassung eines Kraftfahrzeugs oder Kraftfahrzeug Anhängers" 
...
"Straßenverkehrszulassungsordnung" (StVZO), which is the Road Traffic Licensing Regulations. 
...
TÜV or DEKRA examines various aspects of the vehicle. This includes assessing the condition of the chassis, 
...
I received the "HU-Plakette" when I visited the registration office (KFZ-Zulassungsbehörde) to register the car. 
